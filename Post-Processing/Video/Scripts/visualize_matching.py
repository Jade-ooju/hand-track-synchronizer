...
def visualize_matching():
    video_path = PROJECT_ROOT / "data" / "raw" / "test_002" / "MR_View.mp4"
    json_path = PROJECT_ROOT / "data" / "raw" / "test_002"
    ...
    m_loader = MotionLoader(str(json_path)) # Now supports directory
    ...
    plt.tight_layout()
    output_file = PROJECT_ROOT / "docs" / "matching_visualization_test002.png"
