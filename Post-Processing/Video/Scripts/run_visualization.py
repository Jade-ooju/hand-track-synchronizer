...
def run_visualization():
    ...
    json_dir = data_root
    output_path = data_root / "viz_output.mp4"
    ...
    m_loader = MotionLoader(str(json_dir))
    ...
    out = cv2.VideoWriter(str(output_path), fourcc, v_loader.fps, (int(v_loader.width), int(v_loader.height)))
